...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
  ...
  $allowed = array('jpg');
  $filenames = "../images/events/" . $db->lastinsertid() . ".jpg";
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="form-group  col-md-8 col-sm-12">
                ...
                <input required type="text" class="form-control" name="events_description" id="events_description" placeholder=" " value="<?php if (isset($_POST['events_description'])) echo $_POST['events_description']; ?>"
                  OnKeyUp="showAjax('events_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('events_duplicate.php','txtString',this.value, 'results_here');">
              ...
              <div class="form-group col-md-4 col-sm-12">
                ...
                <input required type="date" min="<?php echo date('Y-m-d'); ?>" required class="form-control" name="events_date" id="events_date" placeholder=" " value="<?php if (isset($_POST['events_date'])) echo $_POST['events_date']; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                ...
                <a href="events_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a>
              </div>
            </div>
