...
<form method="POST" id="form1" name="form1" onsubmit="return validateForm();">
    ...
    <span id="results_here" class="alert-secondary"></span><input type="hidden" id="results_here1">
        <div class="form-group">
          ...
          <input class="form-control" type="text" name="group" id="group"
              value="<?php if (isset($_POST['group'])) echo $_POST['group']; else echo $row_rs['group']; ?>" size="32" 
              OnKeyUp="showAjax('user_group_duplicate.php','txtString',this.value + '&prev_id=<?php echo $row_rs['group'];?>' , 'results_here');" placeholder=" ">
  ...
  <input type="hidden" name="id" value="<?php echo $row_rs['group']; ?>">
