...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO user_group (`group`) VALUES (?)";
    $db->query($SQLcrud);
                ...
                <div class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" name="group" id="group"
                                value="<?php if (isset($_POST['group'])) echo $_POST['group'];?>"
                                OnKeyUp="showAjax('user_group_duplicate.php','txtString',this.value, 'results_here');"
                                Onblur="showAjax('user_group_duplicate.php','txtString',this.value, 'results_here');"
                                placeholder=" ">
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <a href="user_group_list.php" class="btn btn-outline-danger hidelink"><span
