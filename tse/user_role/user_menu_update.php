...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
  ...
  if ($rsparent_menu_total>0) {$breadcrumbs=htmlentities($rsparent_menu['Name'].' / '.$_POST['name']);}
    ...
    $db->bind(4,$_POST['icon']);
    $db->bind(5,$_POST['type']);
    $db->bind(6,$_POST['order']);
    ...
    <fieldset>    
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="name" id="name"
              value="<?php if (isset($_POST['name'])) echo $_POST['name']; else echo $row_rs['name']; ?>" size="32"
              OnKeyUp="showAjax('user_menu_duplicate.php','txtString',this.value + '&prev_id=<?php if (isset($_POST['prev_id']))echo $_POST['prev_id']; else echo $row_rs['name'];?>' , 'results_here');">
      </div>
<br>
        <div class="form-group">
            <!-- Text input-->
            <label for=""><strong>Link</strong></label>
                <input name="href" id="href"  type="text" class="form-control" value="<?php echo $row_rs['href']; ?>" size="32">
        </div>
        <br>
         <div class="form-group">
          <!-- Text input-->
          <label for=""><strong>Parent Menu</strong></label>
            <select name="parent_id" id="parent_id" class="form-select ">
              <option value=""></option>
                ...
                <?php if ( !(strcmp($row_rsmenu['id'], $row_rs['parent_id']))){echo "selected=\"selected\"";}?>>
              ...
              ?>
                ...
                <?php if (!(strcmp($rssub_data['id'], $row_rs['parent_id']))){echo "selected=\"selected\"";}?>>
        ...
        <div class="form-group">
            ...
            <div class="input-group"><span class="input-group-text" id="inputGroupPrepend">
              ...
              <input type="text" name="icon" id="icon" class="form-control col-md-6 col-sm-12" value="<?php echo $row_rs['icon']; ?>">
                </div>
        ...
        <div class="form-group">
            <label for=""><strong>Type</strong></label>
                <select  name="type" id="type" class="form-select ">
                    <option value="m"
                        <?php if (!(strcmp("m", $row_rs['type']))){echo "selected=\"selected\"";}?>>Main Menu</option>
                    <option value=""
                        <?php if (!(strcmp("", $row_rs['type']))){echo "selected=\"selected\"";}?>></option>
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" name="order" id="order"
              value="<?php if (isset($_POST['order'])) echo $_POST['order']; else echo $row_rs['order']; ?>" size="32">
        </div>
