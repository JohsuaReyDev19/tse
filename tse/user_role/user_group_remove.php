...
<form id="form1" name="form1" method="post">
  <div class="form-horizontal">
    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="group" id="group"  readonly value="<?php echo $row_rs['group']; ?>" placeholder=" " >
  ...
  <input type="hidden" name="id" id="id" value="<?php echo htmlentities($row_rs['group']);?>">    
</form> 
