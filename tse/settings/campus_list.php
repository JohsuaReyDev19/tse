            ...
            <th>Campus</th>
               <th data-sortable="false"  width="110px">
                <div class="btn-group" role="group" align="center">
                     <?php if (!(strcmp($phu-> set_button_group($_SESSION['AIT_MM_UserGroup'],"campus_new.php"),1))){ ?>
                    <a href="campus_new.php" class="btn btn-outline-secondary" data-toogle="tooltip" data-placement="bottom" title="New"><span class="bi-plus-square"></span> </a>
                    <?php } ?>
...
<?php foreach ($rs as $rs_data){ ?>
    <tr >
    <td class="align-middle"><?php echo htmlentities($rs_data['campus']); ?></td>
    <td  class="align-middle" width="110px">
        <div class="btn-group" role="group" align="center">
             <?php if (!(strcmp($phu-> set_button_group($_SESSION['AIT_MM_UserGroup'],"campus_update.php"),1))){ ?>
            <a href="campus_update.php?recordID=<?php echo $rs_data['campus'];?>" class="btn btn-outline-success" data-toogle="tooltip" data-placement="bottom" title="Update"><span class="bi-pencil-square"></span></a>
            <?php } ?>
             <?php if (!(strcmp($phu-> set_button_group($_SESSION['AIT_MM_UserGroup'],"campus_remove.php"),1))){ ?>
            <a href='campus_remove.php?recordID=<?php echo $rs_data["campus"];?>' class="btn btn-outline-danger" data-toogle="tooltip" data-placement="bottom" title="Remove"><span class="bi-trash"></span></a>
            <?php }?>
        </div>
    </td>
    </tr>
...
<div class="modal fade" id="modalDialogPrint" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body"><div id="printArea"><?php require('campus_print.php'); ?></div></div>
