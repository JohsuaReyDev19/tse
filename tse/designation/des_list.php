...
$query_rs = "select * FROM `designation` order by `designation`";
$db->query($query_rs);
$rs=$db->rowset();
            ...
            <th>Designation</th>
               <th data-sortable="false"  width="110px">
                <div class="btn-group" role="group" align="center">
                    <a href="des_new.php" class="btn btn-outline-secondary" data-toogle="tooltip" data-placement="bottom" title="New"><span class="bi-plus-square"></span> </a>
...
<?php foreach ($rs as $rs_data){ ?>
    <tr >
    <td class="align-middle"><?php echo htmlentities($rs_data['designation']); ?></td>
    <td  class="align-middle" width="110px">
        <div class="btn-group" role="group" align="center">
            <a href="des_update.php?recordID=<?php echo $rs_data['designation'];?>" class="btn btn-outline-success" data-toogle="tooltip" data-placement="bottom" title="Update"><span class="bi-pencil-square"></span></a>
            <a href='des_remove.php?recordID=<?php echo $rs_data["designation"];?>' class="btn btn-outline-danger" data-toogle="tooltip" data-placement="bottom" title="Remove"><span class="bi-trash"></span></a>
        </div>
    </td>
    </tr>
<?php } ?>
...
<div class="modal fade" id="modalDialogPrint" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body"><div id="printArea"><?php require('des_print.php'); ?></div></div>
