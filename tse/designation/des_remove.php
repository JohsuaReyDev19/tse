...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "DELETE FROM designation WHERE `designation` = ?";
    $db->query($SQLcrud);
    $db->bind(1,$_POST['id']);
    $db->execute();
...
<form id="form1" name="form1" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input name="designation" type="text" class="form-control input-md" readonly value="<?php echo $row_rs['designation']; ?>"  placeholder=" ">
        ...
        <div class="col-md-10">
          ...
          <a href="des_list.php" class="btn btn-outline-primary hidelink"><span class="bi-x-octagon"></span> No</a>
          </div>
        </div>
    ...
    <input type="hidden" name="id" id="id" value="<?php echo htmlentities($row_rs['designation']);?>">    
</form> 
