...
<form method="POST" id="form1" name="form1" onsubmit="return validateForm();">
    ...
    <fieldset>    
        ...
        <div class="form-group">
              ...
              value="<?php if (isset($_POST['designation'])) echo $_POST['designation']; else echo $row_rs['designation']; ?>" size="32" 
              OnKeyUp="showAjax('des_duplicate.php','txtString',this.value + '&prev_id=<?php echo $row_rs['designation'];?>' , 'results_here');"  placeholder=" ">
        ...
        <div class="form-group">
          ...
          <a href="des_list.php" class="btn btn-outline-danger"><span class="bi-x-octagon"></span> Cancel</a>
          </div>
        </div>
  ...
  <input type="hidden" name="id" value="<?php echo $row_rs['designation']; ?>">
