...
<div class="row">
  <div class="col-md-4" align="center">
    <div class="card" >
      <img id="image_preview1" src="../images/logo.png" class="img-fluid" />
      <div class="card-body">
        <label for="image-upload1" class="form-label">Upload Logo  (Type: .png | Max. 7MB)</label>
  ...
  <div class="col-md-4" align="center">
    <div class="card" >
      <img id="image_preview2" src="../images/front.png" class="img-fluid"/>
      <div class="card-body">
        <label for="image-upload2" class="form-label">Upload Background Image  (Type: .png | Max. 7MB)</label>
...
<script>
  ...
  $(document).ready(function() {
        $('#image-upload1').change(function() {
            ...
            var validImageTypes = ['image/png', 'image/png'];
            if ($.inArray(fileType, validImageTypes) < 0) {
                Swal.fire('$app_title', 'Please select a PNG file.', 'info');
                clearImage1();
                this.value = '';
            } else if (fileSize > 10485760) {
                Swal.fire('$app_title', 'File size exceeds 7MB. Please select a PNG file less than 7MB.', 'info');
                clearImage1();
                this.value = '';
            }
        });
