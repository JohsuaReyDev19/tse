...
-->
      ...
      <header id="header" class="header fixed-top d-flex align-items-center">
         <div class="d-flex align-items-center justify-content-between"> <a href="#" class="logo d-flex align-items-center"> <img src="../images/logo.png?t=<?php echo time();?>" class="img-responsive" alt=""> <span class="d-none d-lg-block"><?php echo $app_title;?></span></a>
         <i class="bi bi-list toggle-sidebar-btn"></i><span style="font-size:26px;color:white;font-weight:bold"><?php echo $tagline; ?></span></div>
            ...
            <ul class="d-flex align-items-center">
               ...
               <li class="nav-item dropdown pe-3">
                  <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown"> 
                     <img src="
                     <?php $filename='../images/user/'.$_SESSION['AIT_MM_ID'].'.jpg';
                           if (file_exists($filename)) {
                              echo $filename.'?t='.time();
                           } else {
                              echo $app_user_image_default;}?>" ;

                     alt="Profile" class="rounded"> <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $_SESSION['AIT_MM_FullName'];?></span> </a>
      ...
      <aside id="sidebar" class="sidebar">
        ...
        foreach ($rs_menu as $row_rs_menu){ 
             ...
             if ($totalRows_rssub==0) {
                 if (!(strcmp($phu-> found_group($_SESSION['AIT_MM_UserGroup'],$row_rs_menu['id']),1))){
                ...
                if (!(strcmp($phu-> found_group($_SESSION['AIT_MM_UserGroup'],$row_rs_menu['id']),1))) {
                    ...
                    echo '<ul id="'.htmlentities($row_rs_menu["description"]).'" class="nav-content collapse " data-bs-parent="#sidebar-nav">';
                     ...
                     foreach ($rssub as $row_rssub){  
                         ...
                         if (!(strcmp($phu-> found_group($_SESSION['AIT_MM_UserGroup'],$row_rssub['id']),1))) {
